...
def basic_check(model, bt, prop_type, var_ord_type, val_ord_type, trace_BT=False):
    for i in range(1, 4):
...
if __name__ == '__main__':
    basic_check(battleship_csp_model1, battleship_BT, 'BT', ord_random, val_arbitrary)
    basic_check(battleship_csp_model1, battleship_BT, 'BT', ord_random, val_decrease_lcv)
    basic_check(battleship_csp_model1, battleship_BT, 'BT', ord_random, val_decreasing_order)
    basic_check(battleship_csp_model1, battleship_BT, 'BT', ord_random, val_increasing_order)
    basic_check(battleship_csp_model1, battleship_BT, 'BT', ord_random, val_lcv)
    basic_check(battleship_csp_model1, battleship_BT, 'BT', ord_mrv, val_decreasing_order)
    basic_check(battleship_csp_model1, battleship_BT, 'BT', ord_dh, val_decreasing_order)
    basic_check(battleship_csp_model2, BT, 'BT', ord_random, val_arbitrary)
