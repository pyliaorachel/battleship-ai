...
HEADER = 'model,board size,target size,propagation type,variable ordering type,value ordering type,runtime\n'
...
def advanced_test_model1(filename, validity_check=False, trace_BT=False):
    with open(os.path.join(results, filename), 'w') as f:
        f.write(HEADER)
        model = battleship_csp_model1
...
if __name__ == '__main__':
    ...
    advanced_test_model1('advanced_test_model1.csv')
